        ...
        f.prototype.render = function () {
            ...
            for (h in f.shapes) {
                    ...
                    e[h] && e[h].diabled ? a.attr({
                        ...
                        }), a.click(function(){//省份点击事件
                            var id = this.mapId;
                            if(id == "26"){
                                //内蒙古
                                window.open("../themes/nmg.html");
                            }else if(id == "28"){
                                //新疆
                                window.open("../themes/ksyc.html");
                            }else if(id == "29"){
                                //西藏
                                window.open("../themes/txxz.html");
                            }else if(id == "19"){
                                //西宁  青海
                                window.open("../themes/jkxn.html");
                            }else if(id == "17"){
                                //四川
                                window.open("../themes/sichuan.html");
                            }else if(id == "16"){
                                //贵州
                                window.open("../themes/ysgz.html");
                            }else if(id == "27"){
                                //广西  柳州
                                window.open("../themes/gxlz.html");
                            }else if(id == "14"){
                                //福建 莆田
                                window.open("../themes/fjpt.html");
                            }else if(id == "13"){
                                //江西
                                window.open("../themes/jx.html");
                            }else if(id == "12"){
                                //湖北
                                window.open("../themes/hb.html");
                            }else if(id == "21"){
                                //上海
                                window.open("https://www.eimageglobal.com/triageIndex.htm");
                            }else if(id == "7"){
                                //安徽 合肥
                            }else{
                                //其他省份
                            }
                        }), a.hover(function(){//a==>省份
                            var id = this.mapId;
                            //console.log('svg'+id);
                            $(".svg"+id).css({"opacity":"1","color":"#000"});

                        //===========================
                        },function(){
                            var id = this.mapId;
                            //alert('svg'+id);
                            $(".svg-map span").css({"opacity":"0","color":"#898989"});
                        }), g.mousemove(function () {//g==>文字.
